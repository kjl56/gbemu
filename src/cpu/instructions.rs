...
pub enum LoadType {
  ...
  AToAddress(LoadTarget, LoadSource),
  AddressToA(LoadTarget, LoadSource),
}
#[derive(Debug)]
pub enum JumpTest {
  NotZero,
...
impl Instruction {
  ...
  fn from_byte_not_prefixed(byte: u8) -> Option<Instruction> {
    match byte {
      ...
      0x02 => Some(Instruction::LD(LoadType::AToAddress(LoadTarget::BC, LoadSource::A))),
      0x03 => Some(Instruction::INC(IncDecTarget::BC)),
      0x04 => Some(Instruction::INC(IncDecTarget::B)),
      0x05 => Some(Instruction::DEC(IncDecTarget::B)),
      0x06 => Some(Instruction::LD(LoadType::Byte(LoadTarget::B, LoadSource::D8))),
      0x07 => Some(Instruction::RLCA()),
      0x08 => Some(Instruction::LD(LoadType::Word(LoadTarget::D16, LoadSource::SP))),
      0x09 => Some(Instruction::ADD(ArithmeticTarget::HL, ArithmeticSource::BC)),
      0x0A => Some(Instruction::LD(LoadType::AddressToA(LoadTarget::A, LoadSource::BC))),
      ...
      0x11 => Some(Instruction::LD(LoadType::Word(LoadTarget::DE, LoadSource::D16))),
      0x12 => Some(Instruction::LD(LoadType::AToAddress(LoadTarget::DE, LoadSource::A))),
      0x13 => Some(Instruction::INC(IncDecTarget::DE)),
      0x14 => Some(Instruction::INC(IncDecTarget::D)),
      0x15 => Some(Instruction::DEC(IncDecTarget::D)),
      0x16 => Some(Instruction::LD(LoadType::Byte(LoadTarget::D, LoadSource::D8))),
      ...
      0x1a => Some(Instruction::LD(LoadType::AddressToA(LoadTarget::A, LoadSource::DE))),
      0x1b => Some(Instruction::DEC(IncDecTarget::DE)),
      0x1c => Some(Instruction::INC(IncDecTarget::E)),
      0x1d => Some(Instruction::DEC(IncDecTarget::E)),
      0x1e => Some(Instruction::LD(LoadType::Byte(LoadTarget::E, LoadSource::D8))),
      0x1f => Some(Instruction::RRA()),
      0x20 => Some(Instruction::JR(JumpTest::NotZero, JumpTarget::D16)),
      0x21 => Some(Instruction::LD(LoadType::Word(LoadTarget::HL, LoadSource::D16))),
      0x22 => Some(Instruction::LD(LoadType::AToAddress(LoadTarget::HLI, LoadSource::A))),
      0x23 => Some(Instruction::INC(IncDecTarget::HL)),
      0x24 => Some(Instruction::INC(IncDecTarget::H)),
      0x25 => Some(Instruction::DEC(IncDecTarget::H)),
      0x26 => Some(Instruction::LD(LoadType::Byte(LoadTarget::H, LoadSource::D8))),
      ...
      0x2a => Some(Instruction::LD(LoadType::AddressToA(LoadTarget::A, LoadSource::HLI))),
      0x2b => Some(Instruction::DEC(IncDecTarget::HL)),
      0x2c => Some(Instruction::INC(IncDecTarget::L)),
      0x2d => Some(Instruction::DEC(IncDecTarget::L)),
      0x2e => Some(Instruction::LD(LoadType::Byte(LoadTarget::L, LoadSource::D8))),
      ...
      0x3a => Some(Instruction::LD(LoadType::AddressToA(LoadTarget::A, LoadSource::HLD))),
      0x3b => Some(Instruction::DEC(IncDecTarget::SP)),
      0x3c => Some(Instruction::INC(IncDecTarget::A)),
      0x3d => Some(Instruction::DEC(IncDecTarget::A)),
      0x3e => Some(Instruction::LD(LoadType::Byte(LoadTarget::A, LoadSource::D8))),
      0x3f => Some(Instruction::CCF()),
      0x40 => Some(Instruction::LD(LoadType::Byte(LoadTarget::B, LoadSource::B))),
      0x41 => Some(Instruction::LD(LoadType::Byte(LoadTarget::B, LoadSource::C))),
      0x42 => Some(Instruction::LD(LoadType::Byte(LoadTarget::B, LoadSource::D))),
      0x43 => Some(Instruction::LD(LoadType::Byte(LoadTarget::B, LoadSource::E))),
      0x44 => Some(Instruction::LD(LoadType::Byte(LoadTarget::B, LoadSource::H))),
      0x45 => Some(Instruction::LD(LoadType::Byte(LoadTarget::B, LoadSource::L))),
      0x46 => Some(Instruction::LD(LoadType::AddressToA(LoadTarget::B, LoadSource::HL))),
      0x47 => Some(Instruction::LD(LoadType::Byte(LoadTarget::B, LoadSource::A))),
      0x48 => Some(Instruction::LD(LoadType::Byte(LoadTarget::C, LoadSource::B))),
      0x49 => Some(Instruction::LD(LoadType::Byte(LoadTarget::C, LoadSource::C))),
      0x4a => Some(Instruction::LD(LoadType::Byte(LoadTarget::C, LoadSource::D))),
      0x4b => Some(Instruction::LD(LoadType::Byte(LoadTarget::C, LoadSource::E))),
      0x4c => Some(Instruction::LD(LoadType::Byte(LoadTarget::C, LoadSource::H))),
      0x4d => Some(Instruction::LD(LoadType::Byte(LoadTarget::C, LoadSource::L))),
      0x4e => Some(Instruction::LD(LoadType::AddressToA(LoadTarget::C, LoadSource::HL))),
      0x4f => Some(Instruction::LD(LoadType::Byte(LoadTarget::C, LoadSource::A))),
      0x50 => Some(Instruction::LD(LoadType::Byte(LoadTarget::D, LoadSource::B))),
      0x51 => Some(Instruction::LD(LoadType::Byte(LoadTarget::D, LoadSource::C))),
      0x52 => Some(Instruction::LD(LoadType::Byte(LoadTarget::D, LoadSource::D))),
      0x53 => Some(Instruction::LD(LoadType::Byte(LoadTarget::D, LoadSource::E))),
      0x54 => Some(Instruction::LD(LoadType::Byte(LoadTarget::D, LoadSource::H))),
      0x55 => Some(Instruction::LD(LoadType::Byte(LoadTarget::D, LoadSource::L))),
      0x56 => Some(Instruction::LD(LoadType::AddressToA(LoadTarget::D, LoadSource::HL))),
      0x57 => Some(Instruction::LD(LoadType::Byte(LoadTarget::D, LoadSource::A))),
      0x58 => Some(Instruction::LD(LoadType::Byte(LoadTarget::E, LoadSource::B))),
      0x59 => Some(Instruction::LD(LoadType::Byte(LoadTarget::E, LoadSource::C))),
      0x5a => Some(Instruction::LD(LoadType::Byte(LoadTarget::E, LoadSource::D))),
      0x5b => Some(Instruction::LD(LoadType::Byte(LoadTarget::E, LoadSource::E))),
      0x5c => Some(Instruction::LD(LoadType::Byte(LoadTarget::E, LoadSource::H))),
      0x5d => Some(Instruction::LD(LoadType::Byte(LoadTarget::E, LoadSource::L))),
      0x5e => Some(Instruction::LD(LoadType::AddressToA(LoadTarget::E, LoadSource::HL))),
      0x5f => Some(Instruction::LD(LoadType::Byte(LoadTarget::E, LoadSource::A))),
      0x60 => Some(Instruction::LD(LoadType::Byte(LoadTarget::H, LoadSource::B))),
      0x61 => Some(Instruction::LD(LoadType::Byte(LoadTarget::H, LoadSource::C))),
      0x62 => Some(Instruction::LD(LoadType::Byte(LoadTarget::H, LoadSource::D))),
      0x63 => Some(Instruction::LD(LoadType::Byte(LoadTarget::H, LoadSource::E))),
      0x64 => Some(Instruction::LD(LoadType::Byte(LoadTarget::H, LoadSource::H))),
      0x65 => Some(Instruction::LD(LoadType::Byte(LoadTarget::H, LoadSource::L))),
      0x66 => Some(Instruction::LD(LoadType::AddressToA(LoadTarget::H, LoadSource::HL))),
      0x67 => Some(Instruction::LD(LoadType::Byte(LoadTarget::H, LoadSource::A))),
      0x68 => Some(Instruction::LD(LoadType::Byte(LoadTarget::L, LoadSource::B))),
      0x69 => Some(Instruction::LD(LoadType::Byte(LoadTarget::L, LoadSource::C))),
      0x6a => Some(Instruction::LD(LoadType::Byte(LoadTarget::L, LoadSource::D))),
      0x6b => Some(Instruction::LD(LoadType::Byte(LoadTarget::L, LoadSource::E))),
      0x6c => Some(Instruction::LD(LoadType::Byte(LoadTarget::L, LoadSource::H))),
      0x6d => Some(Instruction::LD(LoadType::Byte(LoadTarget::L, LoadSource::L))),
      0x6e => Some(Instruction::LD(LoadType::AddressToA(LoadTarget::L, LoadSource::HL))),
      0x6f => Some(Instruction::LD(LoadType::Byte(LoadTarget::L, LoadSource::A))),
      0x70 => Some(Instruction::LD(LoadType::AToAddress(LoadTarget::HL, LoadSource::B))),
      0x71 => Some(Instruction::LD(LoadType::AToAddress(LoadTarget::HL, LoadSource::C))),
      0x72 => Some(Instruction::LD(LoadType::AToAddress(LoadTarget::HL, LoadSource::D))),
      0x73 => Some(Instruction::LD(LoadType::AToAddress(LoadTarget::HL, LoadSource::E))),
      0x74 => Some(Instruction::LD(LoadType::AToAddress(LoadTarget::HL, LoadSource::H))),
      0x75 => Some(Instruction::LD(LoadType::AToAddress(LoadTarget::HL, LoadSource::L))),
      0x76 => Some(Instruction::HALT()),
      0x77 => Some(Instruction::LD(LoadType::AToAddress(LoadTarget::HL, LoadSource::A))),
      0x78 => Some(Instruction::LD(LoadType::Byte(LoadTarget::A, LoadSource::B))),
      0x79 => Some(Instruction::LD(LoadType::Byte(LoadTarget::A, LoadSource::C))),
      0x7a => Some(Instruction::LD(LoadType::Byte(LoadTarget::A, LoadSource::D))),
      0x7b => Some(Instruction::LD(LoadType::Byte(LoadTarget::A, LoadSource::E))),
      0x7c => Some(Instruction::LD(LoadType::Byte(LoadTarget::A, LoadSource::H))),
      0x7d => Some(Instruction::LD(LoadType::Byte(LoadTarget::A, LoadSource::L))),
      0x7e => Some(Instruction::LD(LoadType::AddressToA(LoadTarget::A, LoadSource::HL))),
      ...
      0xe0 => Some(Instruction::LDH(LoadType::Byte(LoadTarget::D8, LoadSource::A))),
      0xe1 => Some(Instruction::POP(StackTarget::HL)),
      0xe2 => Some(Instruction::LD(LoadType::AToAddress(LoadTarget::AddrPC, LoadSource::A))),
      ...
      0xea => Some(Instruction::LD(LoadType::AToAddress(LoadTarget::D16, LoadSource::A))),



      0xee => Some(Instruction::XOR(ArithmeticTarget::A, ArithmeticSource::D8)),
      0xef => Some(Instruction::RST(JumpTarget::Addr28)),
      0xf0 => Some(Instruction::LDH(LoadType::Byte(LoadTarget::A, LoadSource::D8))),
      0xf1 => Some(Instruction::POP(StackTarget::AF)),
      0xf2 => Some(Instruction::LD(LoadType::AddressToA(LoadTarget::A, LoadSource::AddrPC))),
      0xf3 => Some(Instruction::DI()),

      0xf5 => Some(Instruction::PUSH(StackTarget::AF)),
      0xf6 => Some(Instruction::OR(ArithmeticTarget::A, ArithmeticSource::D8)),
      0xf7 => Some(Instruction::RST(JumpTarget::Addr30)),
      0xf8 => Some(Instruction::LD(LoadType::Word(LoadTarget::HL, LoadSource::SP8))),
      0xf9 => Some(Instruction::LD(LoadType::Word(LoadTarget::SP, LoadSource::HL))),
      0xfa => Some(Instruction::LD(LoadType::AddressToA(LoadTarget::A, LoadSource::D16))),
